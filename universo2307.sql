...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2013 at 08:21 PM
...
CREATE TABLE IF NOT EXISTS `log_url_info` (
  ...
  PRIMARY KEY (`url_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Log URL Info Table' AUTO_INCREMENT=74 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Log Visitors Table' AUTO_INCREMENT=74 ;
