...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2013 at 01:12 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Config Data' AUTO_INCREMENT=65 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Index Event' AUTO_INCREMENT=46 ;
...
(2, 'catalog_product_price', 'pending', '2013-07-24 02:38:43', '2013-07-24 02:38:43', 'real_time'),
...
(8, 'cataloginventory_stock', 'pending', '2013-07-24 02:38:43', '2013-07-24 02:38:43', 'real_time'),
...
CREATE TABLE IF NOT EXISTS `log_url_info` (
  ...
  PRIMARY KEY (`url_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Log URL Info Table' AUTO_INCREMENT=433 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Log Visitors Table' AUTO_INCREMENT=162 ;
